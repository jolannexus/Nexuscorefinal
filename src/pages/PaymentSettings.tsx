    ...
    const fetchSettings = async () => {
      ...
      try {
        try {
          ...
          console.warn('Network environment constraint loading Payment Settings. Checking local storage cache:', fbErr);
        }
        ...
        console.error('Failed to resolve payment configs:', err);
      }
    };
    fetchSettings();
  }, [tenant?.id]);
